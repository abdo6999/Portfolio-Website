    ...
    <section id="hero" className="snap-start min-h-screen flex items-center justify-center relative px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto text-center z-10">
        <div className="space-y-6 sm:space-y-8">
          ...
          <h1 className="text-white mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight">
            Hello, I am{' '}
            {/* Provide a full-name for screen readers while keeping the animated text visual-only */}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8 sm:mt-10">
            ...
            <GlowingButton variant="secondary" onClick={() => scrollToSection('contact')}>
              <svg aria-hidden="true" className="w-5 h-5 sm:w-6 sm:h-6 inline-block" viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
              Get In Touch
            </GlowingButton>
          </div>

          {/* --- Social Icons --- */}
          <div className="flex gap-6 sm:gap-8 justify-center mt-8 sm:mt-10">
            <a href="https://github.com/abdo6999" target="_blank" rel="noopener noreferrer" aria-label="Open GitHub profile (opens in a new tab)" className="text-gray-400 hover:text-cyan-400 transition-colors">
            ...
            <a href="https://www.linkedin.com/in/abdelrahman-mahmoud-akl/" target="_blank" rel="noopener noreferrer" aria-label="Open LinkedIn profile (opens in a new tab)" className="text-gray-400 hover:text-cyan-400 transition-colors">
            ...
            <a href="mailto:abdelrahman.mahmoud.elsaeed@gmail.com" aria-label="Send email to Abdelrahman" className="text-gray-400 hover:text-cyan-400 transition-colors">
            ...
            <a href="https://wa.me/201095160726" target="_blank" rel="noopener noreferrer" aria-label="Open WhatsApp conversation (opens in a new tab)" className="text-gray-400 hover:text-cyan-400 transition-colors">
              {/* <svg   viewBox="0 0 24 24" fill="currentColor"><path d="M20.52 3.48A11.93 11.93 0 0012 .5 11.93 11.93 0 003.48 3.52 11.93 11.93 0 00.5 12c0 2.11.55 4.08 1.6 5.8L.5 22l4.5-1.2A11.93 11.93 0 0012 23.5c2.11 0 4.08-.55 5.8-1.6A11.93 11.93 0 0023.5 12c0-3.2-1.25-6.2-3.0-8.52zM12 21c-1.9 0-3.7-.5-5.3-1.4l-.4-.2-2.7.7.7-2.6-.2-.4C3.5 15.7 3 13.9 3 12 3 7.6 6.6 4 11 4c2.4 0 4.6 1.1 6 2.9 1.2 1.6 1.9 3.6 1.9 5.4 0 5.52-4.48 10-10 10z"/></svg> */}
              <svg aria-hidden="true" fill="currentColor" className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8"  viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill="currentColor" fillRule="evenodd" clip-rule="evenodd" d="M12 23C10.7764 23 10.0994 22.8687 9 22.5L6.89443 23.5528C5.56462 24.2177 4 23.2507 4 21.7639V19.5C1.84655 17.492 1 15.1767 1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12C23 18.0751 18.0751 23 12 23ZM6 18.6303L5.36395 18.0372C3.69087 16.4772 3 14.7331 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21C11.0143 21 10.552 20.911 9.63595 20.6038L8.84847 20.3397L6 21.7639V18.6303Z" />
              </svg>
            </a>
            <a href="https://www.facebook.com/abdoakl236/" target="_blank" rel="noopener noreferrer" aria-label="Open Facebook profile (opens in a new tab)" className="text-gray-400 hover:text-cyan-400 transition-colors">
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <svg aria-hidden="true" className="w-8 h-8 sm:w-10 sm:h-10 text-cyan-400" viewBox="0 0 24 24" fill="none"><path d="M6 9l6 6 6-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
        </div>
      </div>
    </section>
  );
